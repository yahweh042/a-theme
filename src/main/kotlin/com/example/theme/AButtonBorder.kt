...
class AButtonBorder : DarculaButtonPainter() {
    ...
    override fun paintBorder(component: Component, graphics: Graphics, x: Int, y: Int, width: Int, height: Int) {
        ...
        //     val bw = 0f
        //     var arc =
        //         if (DarculaButtonUI.isTag(component)) height - bw * 2 - borderWidth * 2 else DarculaUIUtil.BUTTON_ARC.float
        ...
        //                 DarculaUIUtil.paintTag(
        //                     g2,
        //                     r.width.toFloat(),
        //                     r.height.toFloat(),
        //                     component.hasFocus(),
        //                     DarculaUIUtil.computeOutlineFor(component)
        //                 )
        //             } else {
        //                 val type =
        //                     if (DarculaButtonUI.isDefaultButton(component as JComponent)) Outline.defaultButton else Outline.focus
